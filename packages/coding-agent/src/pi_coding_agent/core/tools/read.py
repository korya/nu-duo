...
The :class:`pi_agent_core.AgentTool` produced by :func:`create_read_tool`
...
from pi_coding_agent.core.tools.path_utils import resolve_read_path
    ...
    *,
    ...
    async def execute(
        ...
        if mime_type is not None:
            ...
            from pi_ai.types import ImageContent as _ImageContent  # noqa: PLC0415
