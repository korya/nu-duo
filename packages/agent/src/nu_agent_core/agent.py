...
stateful skin over :func:`nu_agent_core.agent_loop.run_agent_loop`.
...
from nu_agent_core.agent_loop import run_agent_loop, run_agent_loop_continue
...
if TYPE_CHECKING:
    ...
    from nu_ai.types import ThinkingBudgets, Transport
