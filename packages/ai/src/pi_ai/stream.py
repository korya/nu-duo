...
triggers :func:`pi_ai.providers.register_builtins.register_builtin_providers`
...
from pi_ai.providers import register_builtins as _register_builtins  # noqa: F401  # pyright: ignore[reportUnusedImport]

if TYPE_CHECKING:
    from pi_ai.api_registry import ApiProvider
